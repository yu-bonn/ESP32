...
def scd41_parse_data(data):
    ...
    client.publish("i483/sencer/2410139/SCD41/co2", f"{co2}".encode())
    print("Publish SCD41_CO2")
    client.publish("i483/sencer/2410139/SCD41/temp", f"{temp_num}".encode())
    print("Publish SCD41_temp")
    client.publish("i483/sencer/2410139/SCD41/h", f"{h_num}".encode())
...
def compute(coef, raw_temp, raw_press):
    ...
    client.publish("i483/sencer/2410139/BMP180/temp", f"{T/10}".encode())
    print("Publish BMP180_temp")
    client.publish("i483/sencer/2410139/BMP180/pressure", f"{p/100}".encode())
