...
def net_setup() -> MQTTClient:
    ...
    mqtt_client:MQTTClient = MQTTClient(client_id = "s2410139", server = "150.65.230.59")
...
def scd41_parse_data(data):
    ...
    client.publish("i483/sensors/s2410139/SCD41/co2", f"{co2}".encode())
    time.sleep(1)
    print("Publish SCD41_CO2")
    client.publish("i483/sensors/s2410139/SCD41/temperature", f"{temp_num:.2f}".encode())
    time.sleep(1)
    print("Publish SCD41_temp")
    client.publish("i483/sensors/s2410139/SCD41/humidity", f"{h_num:.2f}".encode())
...
def compute(coef, raw_temp, raw_press):
    ...
    client.publish("i483/sensors/s2410139/BMP180/temperature", f"{T/10}".encode())
    time.sleep(1)
    print("Publish BMP180_temp")
    client.publish("i483/sensors/s2410139/BMP180/air_pressure", f"{p/100}".encode())
